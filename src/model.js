...
export const MODEL_PRESETS = [
  ...
  },
  {
    ...
    // Санузел: правая стенка и низ. Левая — та самая перегородка спальни, верх —
    // стена контейнера. Координаты по коробке, от левого верхнего угла.
    walls: [
      { x: 5780, y: 100,  w: 100,  h: 1300 },     // правая стенка санузла
      { x: 3700, y: 1400, w: 2180, h: 100 },      // низ санузла, вдоль дома
    ],
    ...
    spots: [{ name: "Санузел", x: 4700, y: 700 }],
    needs: [
      { kind: "win",  n: "Окно 900×1900 поворотно-откидное", w: 900,  h: 1900, cost: 0 },
      { kind: "door", n: "Дверь входная 900×2100",           w: 900,  h: 2100, cost: 0 },
      { kind: "win",  n: "Окно 400×800 санузла",             w: 400,  h: 800,  cost: 0 },
      // Панорама в торце гостиной: глухая, створок нет — усиление ей не рисуется.
      { kind: "win",  n: "Витраж 2000×2200 панорамный",      w: 2000, h: 2200, cost: 0,
        face: [{ cells: [{}] }] },
      Object.assign({ cost: 0 }, INNER_DOOR),
    ],
    ...
    openings: [
      { side: "s", pos: 2000, sill: 200, need: 0 },   // окно спальни, H=190 Н под.=20
      { side: "s", pos: 4900, sill: 0,   need: 1 },   // вход, H=210
      { side: "s", pos: 8460, sill: 200, need: 0 },   // окно гостиной
      ...
      // Место по цепочке чертежа: 15 · 70 · 74 справа от ниши — проём 700 от 4340.
      // Полотно 600 стоит в этом проёме по центру: 4340 + 50.
      { side: "wall", wallIdx: 1, pos: 4390, need: 4, into: 1, hinge: "end" },
    ],
  },
];
