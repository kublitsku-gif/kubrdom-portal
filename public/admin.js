...
function tMarketingMain(){
  ...
  html+='<div style="background:linear-gradient(135deg,#005bff15,#00aaff08);border:1.5px solid #005bff33;border-radius:14px;padding:16px;margin-bottom:14px">'+
    ...
    '<div style="display:flex;align-items:center;gap:6px;margin-bottom:12px;flex-wrap:wrap">'+
      ...
      '</div>'+
    '</div>'+
    (function(){var p=settings.aiProvider==="kimi"?"kimi":"deepseek";function pb(k,lbl,col){var on=p===k;return '<button data-a="mkt-provider" data-p="'+k+'" style="padding:6px 12px;border-radius:8px;cursor:pointer;font-size:11px;font-weight:700;border:1.5px solid '+(on?col:"#dde6f0")+';background:'+(on?col:"#fff")+';color:'+(on?"#fff":"#7a9aaa")+'">'+lbl+'</button>';}return '<div style="display:flex;align-items:center;gap:8px;padding:9px 11px;background:#fff;border:1px solid #dde6f0;border-radius:9px;margin-bottom:8px"><span style="font-size:12px;font-weight:700;color:#1a2a3a;flex:1">Модель ИИ</span>'+pb("deepseek","DeepSeek","#16a085")+pb("kimi","Kimi","#6c5ce7")+'</div>';})()+
