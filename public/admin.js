...
function ctTplDocHtml(){
  ...
  return '<!DOCTYPE html><html lang="ru"><head><meta charset="utf-8"><title>Договор подряда № '+num+'</title><style>'+
    ...
    '<ul><li>с планировкой (Приложение № 1 к настоящему Договору),</li>'+
    '<li>графиком платежей (Приложение № 2 к настоящему Договору),</li>'+
    '<li>спецификацией (Приложение № 3 к настоящему Договору),</li>'+
    '<li>актом приема-передачи (Приложение № 4 к настоящему Договору)</li></ul>'+
    '<p>и условиями настоящего Договора. Перечень выполняемых Работ определяется Спецификацией, являющейся неотъемлемой частью Договора. По согласованию Сторон Приложения могут корректироваться в переписке телеграмм или макс на телефонных номерах, указанных в договоре.</p>'+
    '<p><b>1.2.</b> Заказчик обязуется принять и оплатить выполненные Исполнителем работы по предмету настоящего Договора на условиях настоящего Договора.</p>'+

    '<div class="sec">2. Права и обязанности Сторон</div>'+
    '<p><b>2.1.</b> Исполнитель обязан:</p>'+
    '<p><b>2.1.1.</b> Качественно и в надлежащие сроки выполнить своим иждивением и сдать Заказчику работы по предмету настоящего Договора в соответствии и на условиях настоящего Договора.</p>'+
    '<p><b>2.1.2.</b> Осуществить в надлежащие сроки доставку, разгрузку и установку объекта на участок Заказчика за счет средств Заказчика. Точная сумма определяется перед отгрузкой.</p>'+
    '<p><b>2.1.3.</b> Осуществлять контроль и надзор за ходом и качеством выполняемых работ по предмету настоящего Договора. Предоставить Заказчику возможность осуществлять проверку этапов выполнения и качества работ по Договору.</p>'+
    '<p><b>2.1.4.</b> Уведомлять Заказчика об окончании, продлении или приостановке работ по предмету настоящего Договора, а также о любых проблемах, возникающих в ходе исполнения обязательств по предмету настоящего Договора, любым из перечисленных ниже способов в одностороннем порядке: текстовое сообщение или телефонный звонок на номера телефонов, указанные в п. 12 настоящего Договора, либо сообщение на адрес электронной почты, указанный в п. 12 настоящего Договора.</p>'+
    '<p><b>2.2.</b> Исполнитель имеет право:</p>'+
    '<p><b>2.2.1.</b> По согласованию Сторон заменять используемые при выполнении работ по предмету настоящего Договора Материалы на аналогичные по свойствам и качеству.</p>'+
    '<p><b>2.2.2.</b> Размещать, на время строительства, по своему усмотрению рекламные баннеры на Строительной площадке (забор, здания).</p>'+
    '<p><b>2.2.3.</b> При необходимости привлекать к выполнению работ по предмету настоящего Договора третьих лиц.</p>'+
    '<p><b>2.2.4.</b> Использовать фотографии возведенного Объекта в печатных и интернет-изданиях.</p>'+
    '<p><b>2.2.5.</b> Исполнитель вправе извещать Заказчика о завершении любого промежуточного этапа работы и о завершении всех (итоговых) работ по договору путем направления Заказчику фотоснимков результатов соответствующего этапа работ посредством электронной связи через мессенджеры MAX или Telegram, что имеет юридическую силу надлежащего уведомления Исполнителем Заказчика об окончании выполнения промежуточного или итогового этапа работ по договору и необходимости его приемки Заказчиком. Подписывая настоящий договор, Заказчик выражает свое согласие с таким способом направления уведомления о готовности работ к приемке. Уведомления и иные сообщения, направленные одной Стороной, считаются доставленными и полученными другой Стороной по истечении одного календарного дня с момента его отправки.</p>'+
    '<p><b>2.3.</b> Заказчик обязан:</p>'+
    '<p><b>2.3.1.</b> Принять и оплатить на условиях настоящего Договора выполненные работы по предмету настоящего Договора (законченный Объект), а также подписать Акт приема-передачи выполненных работ (Приложение № 4 к настоящему Договору).</p>'+
    '<p><b>2.3.2.</b> Надлежаще оформить необходимые для такого вида работ дополнительные документы (в том числе бухгалтерские) на момент подписания Сторонами Акта приема-передачи выполненных работ (Приложение № 4 к настоящему Договору) в соответствии с условиями настоящего Договора.</p>'+
    '<p><b>2.3.3.</b> Принимать каждый этап выполненных работ по предмету настоящего Договора, приезжая на производственную площадку либо через фото или видео отчет, подписывать промежуточные акты приема-передачи выполненных работ и оплачивать их в соответствии с Графиком платежей (Приложение № 2 к настоящему Договору).</p>'+
    '<p><b>2.4.</b> Заказчик имеет право:</p>'+
    '<p><b>2.4.1.</b> Осуществлять надзор за ходом, качеством, сроками проведения работ по предмету настоящего Договора как лично, так и через своего уполномоченного представителя, предварительно известив об этом Исполнителя и согласовав с Исполнителем время посещения Строительной площадки;</p>'+
    '<p><b>2.4.2.</b> Приостанавливать работы по предмету настоящего Договора в случае несогласия с ходом или качеством таких работ на основании заявления, составленного в простой письменной форме.</p>'+

    '<div class="sec">3. Цена и порядок расчетов</div>'+
    '<p><b>3.1.</b> По согласованию Сторон цена работ по предмету настоящего Договора составляет: <b>'+fmtMoney(amount)+' ('+rubWords(amount)+')</b>.</p>'+
    '<p><b>3.2.</b> По согласованию Сторон расчет по настоящему Договору производится в соответствии с Графиком платежей (Приложение № 2 к настоящему Договору) в валюте РФ (рубли) способом, не противоречащим действующему законодательству РФ, следующим образом:</p>'+
    payItems("3.2.")+
    '<p><b>3.3.</b> Моментом оплаты считается дата зачисления денежных средств на расчетный счет Исполнителя, указанный в п. 12 настоящего Договора, либо дата внесения Заказчиком денежных средств в кассу Исполнителя, либо дата получения расписки в получении денежных средств.</p>'+
    '<p><b>3.4.</b> С письменного согласия Сторон цена выполненных Исполнителем работ по предмету настоящего Договора может быть изменена на основании переписки в телеграмм или макс на телефонных номерах, указанных в договоре.</p>'+
    '<p><b>3.5.</b> ВАЖНО! В стоимость работ не входят расходы по доставке, разгрузке и установке объекта на участке.</p>'+

    '<div class="sec">4. Срок исполнения Договора</div>'+
    '<p><b>4.1.</b> Настоящий Договор вступает в законную силу с момента его подписания Сторонами и действует до полного исполнения Сторонами принятых на себя обязательств.</p>'+
    '<p><b>4.2.</b> Срок выполнения работ по предмету настоящего Договора определен Исполнителем в '+wd+' ('+numWordsRu(wd,false)+') рабочих дней с момента получения первого аванса по настоящему договору подряда, указанному в п. 3.2.1.</p>'+
    '<p><b>4.3.</b> В случае нарушения Заказчиком сроков платежей денежных средств Исполнителю, указанных в п. 3.2 настоящего Договора, срок исполнения условий настоящего Договора увеличивается на количество календарных дней просрочки Заказчиком каждого из платежей.</p>'+
    '<p><b>4.4.</b> По согласованию Сторон срок исполнения условий настоящего Договора Сторонами (отдельно каждого из этапов, указанных в п. 3.2 настоящего Договора) может корректироваться на основании надлежаще оформленных Дополнительных соглашений, являющихся неотъемлемой частью настоящего Договора.</p>'+
    '<p><b>4.5.</b> В случае приостановки работ по предмету настоящего Договора по инициативе Заказчика для исполнения последним условий п. 2.4.2 настоящего Договора, Исполнитель вправе продлить в одностороннем порядке срок исполнения условий настоящего Договора, указанный в п. 4.2 настоящего Договора, на количество календарных дней приостановки работ по предмету настоящего Договора и потребовать от Заказчика возмещение ущерба в результате вынужденного простоя, исходя из расчета 15 000 (пятнадцать тысяч) рублей в день за каждый день простоя. В случае нарушения Исполнителем сроков строительства предусмотрено возмещение 0,1% в день от оставшейся суммы платежей, но не более 5% от суммы всего договора.</p>'+
    '<p><b>4.6.</b> По согласованию Сторон срок исполнения условий настоящего Договора может быть увеличен, в том числе, по причине невозможности соблюдения сроков по настоящему Договору в результате ухудшения погодных условий или непредвиденных обстоятельствах, но не более чем на 30 (тридцать) календарных дней. Исполнитель уведомляет Заказчика об увеличении срока исполнения условий настоящего Договора любым из способов, указанных в п. 2.1.4 настоящего Договора.</p>'+

    '<div class="sec">5. Гарантийные обязательства</div>'+
    '<p><b>5.1.</b> Исполнитель принимает на себя гарантийные обязательства на Объект на '+wm+' ('+numWordsRu(wm,false)+') '+pluralRu(wm,"месяц","месяца","месяцев")+' с момента подписания Сторонами Акта приема-передачи выполненных работ.</p>'+
    '<p><b>5.2.</b> Гарантийные обязательства не распространяются на следующие свойства Материалов из древесины: усадка, усушка, разбухание, появление трещин, появление синевы и деформации вследствие воздействия влажной среды, так как при изготовлении таких Материалов нарушается природная структура древесины.</p>'+
    '<p><b>5.3.</b> Гарантийные обязательства также не распространяются:</p>'+
    '<ul><li>на фундаменты, изготовленные Заказчиком (временные, столбчатые, поверхностные, ленточные, из винтовых свай и т.п.);</li>'+
    '<li>на нарушение целостности конструкции Объекта либо отдельных его частей вследствие разрушения, наклона, обвала или просадки изготовленного Заказчиком фундамента;</li>'+
    '<li>на ущерб, нанесенный Объекту третьими лицами, либо Заказчиком (его представителями), вследствие одностороннего изменения последними технического задания, проекта; а также на ущерб, возникший в результате эксплуатации не в соответствии с существующими нормами;</li>'+
    '<li>на повреждения любых элементов Объекта, в случае, если Заказчик в течение срока действия гарантийных обязательств и во время выполнения работ по предмету настоящего Договора изменяет конструкцию или технико-эксплуатационные параметры Объекта без согласования с Исполнителем;</li>'+
    '<li>на материалы, используемые при проведении работ по предмету настоящего Договора, предоставленные Заказчиком;</li>'+
    '<li>несоблюдение температурно-влажностного режима, несоблюдение норм эксплуатации и мер безопасности;</li>'+
    '<li>на усушку внутренней отделки, и как следствие — в гарантийные обязательства не входит перетяжка отделки;</li>'+
    '<li>на внесение изменений в конструктив, не согласованный с Исполнителем и не заверенный Актом. К подобным изменениям относится перенос перегородок, перенос окон, изменение «пирога» стены, изменение внешнего вида и любые отклонения от технического задания и проекта, указанного в договоре;</li>'+
    '<li>на окна, двери, мебель, сантехнику, инженерное оборудование распространяются гарантийные обязательства производителей.</li></ul>'+
    '<p><b>5.4.</b> Гарантийные обязательства распространяются на протекание кровли и целостность конструкции Объекта.</p>'+
    '<p><b>5.5.</b> После подписания Сторонами Акта приема-передачи выполненных работ претензии по качеству Объекта принимаются Исполнителем только в рамках гарантийных обязательств.</p>'+
    '<p><b>5.6.</b> Исполнитель в течение гарантийного срока за свой счет и своими силами устраняет выявленные в процессе эксплуатации Объекта недостатки в рамках гарантийных обязательств.</p>'+
    '<p><b>5.7.</b> Выявленные Заказчиком в рамках гарантийных обязательств недостатки Объекта в течение гарантийного срока оформляются соответствующими Актами, подписанными Сторонами. Без оформления упомянутых выше Актов претензии Заказчика по недостаткам Объекта не подлежат удовлетворению.</p>'+
    '<p><b>5.8.</b> Стороны согласовали, что ввиду того, что морской контейнер является бывшим в употреблении, на фасадной (внешней части) Объекта могут быть незначительные вмятины и иные дефекты, не влияющие на качественные характеристики Объекта. Также допустимы незначительные повреждения внутренней и внешней отделки контейнера, вызванные транспортировкой (мелкие трещины, локальное отклеивание плитки, незначительное изменение расстояния между хлыстами МДФ, незначительная деформация рам и дверей). Подписывая настоящий Договор, Заказчик соглашается с тем, что наличие вышеуказанных дефектов не является основанием для отказа от приемки Объекта.</p>'+

    '<div class="sec">6. Ответственность Сторон</div>'+
    '<p><b>6.1.</b> В случае нарушения срока исполнения условий, указанных в п. 4.2 настоящего Договора, Исполнитель уплачивает Заказчику пени в размере 0,1 % от цены, указанной в п. 3.1 настоящего Договора, за каждый день просрочки, но всего не более 5 (пяти) % от суммы договора.</p>'+
    '<p><b>6.2.</b> В случае нарушения сроков оплаты, указанных в п. 3.2 настоящего Договора, Заказчик уплачивает Исполнителю пени в размере 0,1 % от цены каждого неоплаченного этапа работ по предмету настоящего Договора за каждый день просрочки, но всего не более 5 (пяти) % от суммы договора, помимо санкций, указанных в других пунктах настоящего Договора.</p>'+
    '<p><b>6.3.</b> В случае неявки уполномоченных представителей Заказчика на приемку выполненных скрытых работ по предмету настоящего Договора в срок, такие работы считаются принятыми и подлежат оплате. Вскрытие Исполнителем выполненных скрытых работ по предмету настоящего Договора считается «Дополнительными работами» и подлежит оплате Заказчиком на основании надлежаще оформленных Дополнительных соглашений, являющихся неотъемлемой частью настоящего Договора.</p>'+
    '<p><b>6.4.</b> В случае, если Заказчик отказывается принимать выполненные работы по предмету настоящего Договора, в том числе, по отдельным этапам таких работ, последний обязан в трехдневный срок с момента отказа, в письменной форме предоставить Исполнителю мотивированные (документально подтвержденные) причины отказа. В противном случае работы по предмету настоящего Договора считаются выполненными, принимаются в полном объеме и подлежат оплате Заказчиком. Без документального подтверждения отказ не является обоснованным.</p>'+
    '<p><b>6.5.</b> За необоснованный отказ Заказчика от приемки выполненных работ по предмету настоящего Договора, Исполнитель имеет право взыскать с Заказчика неустойку в размере 25 (двадцати пяти) % от цены, указанной в п. 3.1 настоящего Договора, что не освобождает Заказчика от полного исполнения условий, указанных в п. 3.2 и п. 6.2 настоящего Договора.</p>'+
    '<p><b>6.6.</b> Применение к ответственной Стороне мер имущественной ответственности не отменяет ее обязанности исполнить иные обязательства по настоящему Договору.</p>'+
    '<p><b>6.7.</b> Стороны пришли к согласию о том, что указанные в настоящем Договоре пределы имущественной ответственности (штрафные санкции) начисляются с момента их письменного признания Сторонами в бесспорном порядке, либо на основании судебного решения. До этого, исключительно в целях бухгалтерского и налогового учетов, пределы имущественной ответственности (штрафные санкции) составляют 0 %.</p>'+
    '<p><b>6.8.</b> В случае, если Заказчик расторгает настоящий Договор в одностороннем порядке до начала работ по предмету настоящего Договора, то в зависимости от количества рабочих дней, прошедших с момента совершения Заказчиком предварительной оплаты в соответствии с условиями п. 3.2 настоящего Договора до момента расторжения настоящего Договора Заказчиком:</p>'+
    '<ul><li>если от 1-го до 5-ти рабочих дней — Заказчику возвращается 100% суммы указанной выше предварительной оплаты;</li>'+
    '<li>если от 5-ти до 13-ти рабочих дней — Заказчику возвращается 50% суммы указанной выше предварительной оплаты;</li>'+
    '<li>если от 14-ти и более рабочих дней — вся сумма указанной выше предварительной оплаты остается у Исполнителя.</li></ul>'+
    '<p><b>6.9.</b> В случае нарушения Заказчиком сроков оплаты, указанных в п. 3.2 настоящего Договора, Исполнитель вправе приостанавливать работы по предмету настоящего Договора до полного исполнения Заказчиком своих обязательств.</p>'+

    '<div class="sec">7. Обстоятельство непреодолимой силы</div>'+
    '<p><b>7.1.</b> Под обстоятельствами непреодолимой силы понимаются обстоятельства, которые могут возникнуть после заключения настоящего Договора в результате непредвиденных или непреодолимых Сторонами событий.</p>'+
    '<p><b>7.2.</b> Стороны освобождаются от ответственности за частичное или полное неисполнение своих обязательств по настоящему Договору, если это неисполнение явилось следствием обстоятельств непреодолимой силы, а именно: чрезмерное воздействие атмосферных осадков и низких температур, повлекшие невозможность выполнения принятых на себя обязательств Сторонами; пожары; наводнения; землетрясения; войны; запретительные акты государственных органов, носящих общий характер, и их последствия, при условии, что эти обстоятельства и их последствия непосредственно повлияли на исполнение обязательств по настоящему Договору. В таком случае срок исполнения обязательств по настоящему Договору продлевается соразмерно времени, в течение которого действовали такие обстоятельства или их последствия при обязательном письменном уведомлении Сторонами друг друга.</p>'+
    '<p><b>7.3.</b> Если последствия, вызванные указанными выше обстоятельствами, будут длиться более 3 (трех) месяцев с момента заключения настоящего Договора, то Стороны встретятся, чтобы обсудить, какие меры можно предпринять в создавшейся ситуации. Если в течение последующего одного месяца Стороны не смогут договориться по существу дела, то каждая из Сторон вправе расторгнуть настоящий Договор в одностороннем порядке.</p>'+

    '<div class="sec">8. Порядок расторжения Договора</div>'+
    '<p><b>8.1.</b> Настоящий Договор может быть расторгнут досрочно на основании письменного соглашения Сторон.</p>'+
    '<p><b>8.2.</b> В случае расторжения настоящего Договора по инициативе Заказчика в период после начала Исполнителем выполнения работ по предмету настоящего Договора, последний документально подтверждает фактически выполненный объем таких работ и понесенные убытки, которые оплачиваются Заказчиком в полном объеме в течение 7 (семи) рабочих дней с момента надлежащего оформления Сторонами Акта взаиморасчетов, являющегося неотъемлемой частью настоящего Договора.</p>'+
    '<p><b>8.3.</b> В случае расторжения настоящего Договора по инициативе Исполнителя в период после начала Исполнителем выполнения работ по предмету настоящего Договора, последний документально подтверждает фактически выполненный объем таких работ и фактические затраты.</p>'+
    '<p><b>8.4.</b> В течение 7 (семи) рабочих дней с момента надлежащего оформления Сторонами Акта взаиморасчетов, являющегося неотъемлемой частью настоящего Договора, полученные от Заказчика денежные средства возвращаются Исполнителем за минусом цены фактически выполненного объема работ по предмету настоящего Договора и фактических понесенных Исполнителем затрат.</p>'+

    '<div class="sec">9. Порядок разрешения споров</div>'+
    '<p><b>9.1.</b> Все споры или разногласия, которые могут возникнуть в связи с исполнением или толкованием настоящего Договора, будут решаться путем переговоров между Сторонами. Стороны устанавливают обязательный претензионный (досудебный) порядок разрешения разногласий по настоящему Договору.</p>'+
    '<p><b>9.2.</b> Претензия направляется в письменной форме в течение 10 (десяти) календарных дней с момента нарушения одной из Сторон обязательств по настоящему Договору с приложением документов (без приложения претензия не рассматривается), подтверждающих факт нарушения обязательств одной из Сторон. Претензия должна быть рассмотрена Стороной, которая получила претензию, в течение 5 (пяти) календарных дней с момента получения такой претензии.</p>'+
    '<p><b>9.3.</b> В случае невозможности разрешения споров путем переговоров, они подлежат разрешению в судебном порядке по территориальной подсудности места нахождения Исполнителя.</p>'+

    '<div class="sec">10. Дополнительные условия</div>'+
    '<p><b>10.1.</b> В случае платного въезда на Строительную площадку Заказчика работников (представителей) Исполнителя для выполнения работ по предмету настоящего Договора, такие расходы оплачивает Заказчик.</p>'+
    '<p><b>10.2.</b> Оплата электроэнергии, израсходованной Исполнителем в период выполнения работ по предмету настоящего Договора, осуществляется Исполнителем.</p>'+
    '<p><b>10.3.</b> По согласованию Сторон (в случае необходимости), подготовка Строительной площадки работниками Исполнителя является «Дополнительными работами» и подлежит оплате Заказчиком на основании надлежаще оформленного Дополнительного соглашения, являющегося неотъемлемой частью настоящего Договора.</p>'+
    '<p><b>10.4.</b> В случае, если Заказчик не готов принять объект на своем участке в течении 3 (трех) календарных дней с момента получения уведомления от Исполнителя о завершении всех работ по настоящему договору и письменно просит Исполнителя временно оставить объект на производственной площадке (либо уклоняется от приемки/вывоза), такой период считается хранением.</p>'+
    '<p><b>10.5.</b> За период хранения (нахождения) объекта на производственной площадке Исполнителя сверх срока, установленного в п. 10.4, Заказчик обязуется уплатить Исполнителю плату за хранение в размере 50 000 (пятьдесят тысяч) рублей за каждый полный или неполный календарный месяц.</p>'+
    '<p><b>10.6.</b> Стороны пришли к согласию о том, что древесина является специфическим строительным материалом, т.к. при обработке, изготовлении и монтаже нарушается ее структура, вследствие этого и чрезмерного воздействия влажной среды возможны: разбухание, появление трещин, появление синевы и деформации. Такие свойства древесины при выполнении работ по предмету настоящего Договора для Сторон не являются существенными.</p>'+
    '<p><b>10.7.</b> С момента подписания настоящего Договора все ранее достигнутые устные договоренности, а также электронные и факсимильные сообщения теряют силу.</p>'+

    '<div class="sec">11. Список приложений</div>'+
    '<p>Приложение 1 — Планировка<br>Приложение 2 — График платежей<br>Приложение 3 — Спецификация<br>Приложение 4 — Акт приемки</p>'+
